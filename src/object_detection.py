...
rel_path = "\src\haarcascades\haarcascade_s10.xml"

# Absolute path to xml. ONLY USED IF ABOVE PATH COULD NOT BE RESOLVED. MAKE SURE THIS PATH EXIST IF NECESSARY
abs_path = "C:\src\haarcascades\haarcascade_s10.xml"
...
# Load the classifier via relative path
cascade = cv2.CascadeClassifier(rel_path)

# Load classifier by absolute path if relative path was not found
if cascade.empty():
...
while True:
    ...
    # GET CAMERA IMAGE AND CONVERT TO GRAYSCALE COLOR_BGR2GRAY
    ...
    for [x, y, w, h] in objects:
        ...
        if area > minArea:
            ...
            cv2.putText(img, obj_name, (x, y-5),
